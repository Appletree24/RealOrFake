...
export const copy = {
    en: {
        ...
        truthBody:
            "Pick how many questions you want this round, then see how often a polished fake rewrites your confidence.",
        chooseCategory: "Choose a scene",
        total: "total",
        startChallenge: "Start challenge",
        changeScene: "Shuffle another set",
        selectedScene: "Selected scene",
        sceneCount: (count: number) => `${count} ${count === 1 ? "question" : "questions"}`,
        randomRunInfo: (count: number) =>
            `This round pulls ${count} random ${count === 1 ? "question" : "questions"}.`,
        mixedPool: "Mixed pool",
        questionsPerRunLabel: "Questions per run",
        questionsPerRunHint: "Pick a preset before you start.",
        allQuestions: "All",
        ...
        outperformedMissedSuffix: "% of players missed this one, but you got it right.",
        seeScore: "See score",
    ...
    zh: {
        ...
        truthBody:
            "先决定这一轮你想做多少题，再看看一张足够精致的假图能多轻易地改写你的判断。",
        ...
        randomRunInfo: (count: number) => `这一轮会随机抽 ${count} 题。`,
        mixedPool: "混合题池",
        questionsPerRunLabel: "每轮题数",
        questionsPerRunHint: "开始前选一个题量档位。",
        allQuestions: "全部",
        todaysSet: "今日题组",
        freshPick: "精选上新",
        newDrop: "今日上新",
        ...
        outperformedMissedSuffix: "% 的玩家选错了，但你答对了。",
        seeScore: "查看分数",
        nextImage: "下一题",
        betterThan: "超过了今日",
        players: "的玩家。",
