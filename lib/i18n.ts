...
export const copy = {
    en: {
        ...
        truthBody:
            "Each run pulls 5 random images from the pool. Trust your eyes, then see how often a polished fake rewrites your confidence.",
        ...
        randomRunInfo: (count: number, total: number) =>
            `${count} random ${count === 1 ? "question" : "questions"} per run from ${total} total`,
    ...
    zh: {
        ...
        truthBody:
            "每一轮都会从题库里随机抽 5 道题。相信你的眼睛，然后看看一张足够精致的假图能多轻易地改写你的判断。",
        ...
        randomRunInfo: (count: number, total: number) => `每轮随机抽 ${count} 题，当前题库共 ${total} 题`,
        mixedPool: "混合题池",
        todaysSet: "今日题组",
        freshPick: "精选上新",
        newDrop: "今日上新",
